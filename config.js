// ═══════════════════════════════════════════════════════════
// BR BUSINESS SYSTEM — CONFIGURATION FILE
// Edit only this file when your settings change
// ═══════════════════════════════════════════════════════════
...
const BR_CONFIG = {
  ...
  MESSAGES: {
    ...
    proposal_followup: "Hi {name}, following up on the proposal I shared — I want to make sure you had a chance to review it and that I answered all your questions. Happy to go through any part of it again. When suits you?",
    ...
    claim_followup: "Hi {name}, just checking in to make sure the claim process is going smoothly for you. Please don't hesitate to call me directly if you need anything — I'm here to make this as easy as possible."
  },
  ...
  PROVIDERS: {
    investment: [
      ...
      'Friends Provident / Evelyn Partners',
      'Generali Worldwide',
      'RL360',
      'Investors Trust',
    ...
    life: [
      ...
      'Friends Provident','SunLife',
      'Takaful Emarat','Al Hilal Takaful','Noor Takaful',
    ...
    general: [
      'Jumbo','AXA','RSA','Oman Insurance','ADNIC'
    ]
  }
};

// ── SHEET NAMES (do not change unless you renamed your sheets)
const SHEETS = {
  contacts:    'CONTACTS',
  policies:    'POLICIES',
